...
class _EditUserProfilePageState extends State<EditUserProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    children: <Widget>[
      ...
      Container(
        margin: EdgeInsets.only(top: 20, bottom: 30, left: 15, right: 15),
        child: TextField(
          controller: newNameController..text = profileName.toString(),
          onChanged: (text) => {},
          obscureText: false,
      ...
      Container(
        ...
        child: TextField(
          controller: newEmailController.. text = profileEmail.toString(),
          onChanged: (text) => {},
          obscureText: false,
          decoration: InputDecoration(
              labelText: 'Email',
